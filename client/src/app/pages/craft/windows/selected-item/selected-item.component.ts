  ...
  constructor(private selectedItem: SelectedItemService) {
    this.selectedItem.selectedItem.subscribe((item) => {
      ...
      for (let componentType of ComponentType) {
        if (
          this.selected?.name == componentType?.name ||
          this.selected?.name == componentType?.id
        ) {
          if (this.selected?.name === 'wheels') {
            this.imgUrl =
              '../../../../../assets/img/inventory/selected/wheel.png';
          } else if (this.selected?.name === 'truck') {
            this.imgUrl =
              '../../../../../assets/img/inventory/selected/truck.png';
          }
        } else if (
          this.selected?.name == componentType?.name ||
          this.skateboardType == 'oldschool'
        ) {
          if (this.selected?.name === 'board') {
            ...
            this.imgUrl =
              '../../../../../assets/img/inventory/selected/oldschool_board_gripTape.png';
          }
        }
      }
    });
